...
url: str = os.environ.get("REMOTE_SUPABASE_URL")
key: str = os.environ.get("REMOTE_SUPABASE_KEY")
print("keys:")
print(url)
print(key)
print("--------------------------------")
...
def main():
    ...
    supabase.table('test_reports').delete().neq('id', 0).execute()  # Delete where id is not equal to 0 (deletes all rows)
    ...
    for report in sample_reports:
        result = supabase.table('test_reports').insert(report).execute()
