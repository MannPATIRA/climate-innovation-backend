...
COMMENT ON TABLE "public"."reports" IS 'Reports that have been fetched and converted to text format are stored here';
...
ALTER TABLE ONLY "public"."reports"
    ADD CONSTRAINT "reports_content_hash_key" UNIQUE ("content_hash");
